...
window.DB.tips = (window.DB.tips || []).concat([
  ...
  { id:"ft1", cat:"Prompts", t:"Empieza por el rol", d:"Asignar un rol experto ('Actúa como planner senior') enfoca y eleva la respuesta antes que cualquier otra cosa." },
  { id:"ft2", cat:"Prompts", t:"Pide el formato de salida", d:"Di si quieres tabla, lista, JSON o HTML. El formato correcto ahorra reformatear después." },
  { id:"ft3", cat:"Prompts", t:"Da 1-3 ejemplos (few-shot)", d:"Mostrar el formato ideal hace que el modelo lo replique con precisión." },
  { id:"ft4", cat:"Prompts", t:"Exige fuentes en lo crítico", d:"'Cita la parte exacta en la que te basas'. Sin fuente, es borrador, no evidencia." },
  { id:"ft5", cat:"Prompts", t:"Itera, no reinicies", d:"Refina la respuesta ('más corto', 'agrega una columna') en vez de empezar de cero." },
  { id:"ft6", cat:"Prompts", t:"Pon lo estable al inicio", d:"Instrucciones y documentos fijos arriba; lo variable abajo. Aprovecha el caché y baja costo." },
  { id:"ft7", cat:"Prompts", t:"Pide que pregunte primero", d:"'Si te falta un dato clave, pregúntamelo antes de responder' evita respuestas genéricas." },
  { id:"ft8", cat:"Prompts", t:"Usa 'piensa paso a paso'", d:"En problemas con lógica o cálculo, el razonamiento explícito sube la precisión." },
  { id:"ft9", cat:"Prompts", t:"Crea un system prompt reutilizable", d:"Fija tono, reglas y formato una vez y reúsalo en todo un flujo o GPT." },
  { id:"ft10", cat:"Prompts", t:"Pide autocrítica", d:"'Revisa tu respuesta y corrige errores antes de entregar' mejora la calidad final." },
  { id:"ft11", cat:"Productividad", t:"Una tarea, un asistente", d:"Convierte tu mejor prompt repetido en un Custom GPT o skill por proceso." },
  { id:"ft12", cat:"Productividad", t:"Plantillas por rol", d:"Ten prompts listos para correos, actas, informes y propuestas: reusar > improvisar." },
  { id:"ft13", cat:"Productividad", t:"La IA hace el borrador", d:"Tú aportas criterio y validas. El primer borrador en 30 s, no en 30 min." },
  { id:"ft14", cat:"Productividad", t:"Resume antes de leer", d:"Pide TL;DR + puntos clave de cualquier documento largo antes de profundizar." },
  { id:"ft15", cat:"Productividad", t:"Convierte voz en texto", d:"Dicta ideas y deja que la IA las estructure: pensar en voz alta es más rápido que teclear." },
  { id:"ft16", cat:"Productividad", t:"Reutiliza tu estilo", d:"Pega 2 textos tuyos y pide 'escribe en este estilo' para mantener tu voz." },
  { id:"ft17", cat:"Productividad", t:"Cierra el loop del día", d:"Pide a la IA que convierta tus notas sueltas en tareas con responsable y fecha." },
  { id:"ft18", cat:"Productividad", t:"Plantea el 'anti-objetivo'", d:"Di qué NO quieres ('sin clichés, sin relleno') para subir la calidad." },
  { id:"ft19", cat:"Documental", t:"Trabaja por secciones", d:"Trocea documentos largos (chunking): mejora precisión y evita exceder el contexto." },
  { id:"ft20", cat:"Documental", t:"Pide la cita y la página", d:"Para normas y contratos, exige referencia exacta: trazabilidad sobre memoria." },
  { id:"ft21", cat:"Documental", t:"Compara dos documentos", d:"'Lista contradicciones entre A y B' detecta inconsistencias en minutos." },
  { id:"ft22", cat:"Documental", t:"Extrae a tabla", d:"Convierte un expediente en tabla: requisito, responsable, fecha, riesgo, página." },
  { id:"ft23", cat:"Documental", t:"Marca lo no confirmado", d:"Pide '[verificar]' en lo que no esté explícito: evita inventar datos." },
  { id:"ft24", cat:"Documental", t:"Usa NotebookLM para tus fuentes", d:"Sube tus PDFs y pregúntales; responde anclado a TU material." },
  { id:"ft25", cat:"Documental", t:"Valida contra checklist", d:"Pide revisar el documento ítem por ítem contra un checklist normativo." },
  { id:"ft26", cat:"Automatización", t:"Ordena antes de automatizar", d:"Si el proceso está mal diseñado, la IA lo hará más rápido… pero peor." },
  { id:"ft27", cat:"Automatización", t:"Empieza por workflow", d:"Pasos fijos primero (control); sube a agente solo si la variabilidad lo exige." },
  { id:"ft28", cat:"Automatización", t:"Pon al humano en lo crítico", d:"Aprobación humana en pagos, envíos y borrados. Automatiza del todo lo de bajo riesgo." },
  { id:"ft29", cat:"Automatización", t:"Diseña para fallar", d:"Maneja errores, reintentos e idempotencia: los flujos reales sí fallan." },
  { id:"ft30", cat:"Automatización", t:"Prefiere API sobre RPA", d:"Si hay API, úsala: más estable que imitar clics en la interfaz." },
  { id:"ft31", cat:"Automatización", t:"Un disparador claro", d:"Define bien el trigger (correo, hora, formulario): es el inicio de todo el flujo." },
  { id:"ft32", cat:"Automatización", t:"Registra todo", d:"Logs y trazas: sin observabilidad no puedes mejorar ni auditar el flujo." },
  { id:"ft33", cat:"Dev", t:"Pide 'sin build, por CDN'", d:"Para prototipos web rápidos, evita configuración: funciona abriendo el HTML." },
  { id:"ft34", cat:"Dev", t:"Cambios en PRs pequeños", d:"Pide al agente refactors por pasos revisables, nunca uno masivo de golpe." },
  { id:"ft35", cat:"Dev", t:"Exige manejo de errores", d:"'Maneja celdas vacías y valida columnas' evita que el script falle con datos reales." },
  { id:"ft36", cat:"Dev", t:"Aprende Git mínimo", d:"commit, branch, PR: te salvan cuando la IA rompe algo." },
  { id:"ft37", cat:"Dev", t:"Define criterios de aceptación", d:"Sin un 'qué es terminado' verificable, el agente entrega algo que solo 'parece' listo." },
  { id:"ft38", cat:"Dev", t:"Pide que explique el código", d:"Que comente y explique: aprendes el patrón en vez de copiar a ciegas." },
  { id:"ft39", cat:"Datos & ML", t:"Primero el problema y el dato", d:"Define variable objetivo y métrica antes de elegir algoritmo." },
  { id:"ft40", cat:"Datos & ML", t:"Separa train/val/test", d:"Evalúa en datos nunca vistos: así no te engañas con el rendimiento." },
  { id:"ft41", cat:"Datos & ML", t:"Desconfía del accuracy perfecto", d:"Suele ser overfitting o fuga de datos. Valida con casos nuevos." },
  { id:"ft42", cat:"Datos & ML", t:"Las features mandan", d:"Invierte en preparar variables antes que en perseguir el modelo de moda." },
  { id:"ft43", cat:"Datos & ML", t:"Tabular → prueba boosting", d:"En datos tipo Excel, XGBoost suele ganar al deep learning." },
  { id:"ft44", cat:"Visión", t:"Varía tus fotos", d:"Ángulos, luz y casos raros importan más que el número de imágenes." },
  { id:"ft45", cat:"Visión", t:"Valida en campo", d:"Un mAP alto en laboratorio no garantiza obra: prueba en condiciones reales." },
  { id:"ft46", cat:"Visión", t:"Define el etiquetado", d:"Una guía clara de anotación evita modelos confundidos." },
  { id:"ft47", cat:"Agentes", t:"Sube autonomía con evidencia", d:"Primero aprueba cada paso; luego supervisa. Nunca saltes a 'automático' en lo crítico." },
  { id:"ft48", cat:"Agentes", t:"Permisos mínimos", d:"Da al agente solo los accesos que necesita. Menos superficie, menos riesgo." },
  { id:"ft49", cat:"Negocio", t:"Demo ≠ valor", d:"Una demo prueba posibilidad; un piloto de 30 días con métrica prueba valor." },
  { id:"ft50", cat:"Negocio", t:"Mide antes y después", d:"Horas, errores, satisfacción. Sin medición no hay ROI, hay opinión." }
]);
